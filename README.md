## Yummy Tummy Community for Recip![CI logo](https://codeinstitute.s3.amazonaws.com/fullstack/ci_logo_small.png)

Welcome monanorremo,

This is the Code Institute student template for Gitpod. We Sharing app
...
This app has been built with materialize css to be fully responsive on all devices and screen sizes. ve preinstalled all of the tools you need to get started. You can safely delete this README.md file, or change it for your own project. Please do read it at least once, though! It contains some important information about Gitpod and the extensions we use.
...
Happy coding!
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNTA1ODg3NDldfQ==
-->